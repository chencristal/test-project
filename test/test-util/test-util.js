...
var testUtil = {
  ...
  seedUserGroups: function() {
    var self = this;
    var userGroups = [
      { "_id" : self.ObjectId("58dfa5a4317b43114750c8ca"), "groupName" : "All Users", "status" : "active", "allUsers" : true, "provider" : "local", "role" : "user" },
      { "_id" : self.ObjectId("58dfa5a4317b43114750c8cb"), "groupName" : "All Authors", "status" : "active", "allUsers" : true, "provider" : "local", "role" : "author" }
    ];
    return UserGroup.create(userGroups);
  },

  seedTermTemplates: function() {
    var self = this;
    var termtemplates = [
      {
          "_id" : self.ObjectId("58e65eae35dc110d1c525852"),
          "boolean" : {
              "default" : true,
      ...
      {
          "_id" : self.ObjectId("58e65ed435dc110d1c525853"),
          "boolean" : {
              "default" : true,
              "exclusionText" : "Exclude",
              "inclusionText" : "Include"
      ...
      {
          "_id" : self.ObjectId("58e65fc935dc110d1c525854"),
          "boolean" : {
              "default" : true,
              "exclusionText" : "Exclude",
              "inclusionText" : "Include"
      ...
      {
          "_id" : self.ObjectId("58e6605b35dc110d1c525855"),
          "boolean" : {
              "default" : true,
              "exclusionText" : "Exclude",
              "inclusionText" : "Include"
      ...
      {
          "_id" : self.ObjectId("58e6618f35dc110d1c525856"),
          "boolean" : {
              "default" : true,
              "exclusionText" : "Exclude",
              "inclusionText" : "Include"
      ...
      {
          "_id" : self.ObjectId("58e6663f35dc110d1c525857"),
          "boolean" : {
              "default" : false,
              "exclusionText" : "False",
              "inclusionText" : "True"
      ...
      {
          "_id" : self.ObjectId("58e6674c35dc110d1c525858"),
          "boolean" : {
              "default" : true,
              "exclusionText" : "Exclude",
              "inclusionText" : "Include"
      ...
      {
          "_id" : self.ObjectId("58e667ab35dc110d1c525859"),
          "boolean" : {
              "default" : true,
              "exclusionText" : "Exclude",
              "inclusionText" : "Include"
      ...
      {
          "_id" : self.ObjectId("58e6681f35dc110d1c52585a"),
          "boolean" : {
              "default" : true,
              "exclusionText" : "Exclude",
              "inclusionText" : "Include"
      ...
      {
          "_id" : self.ObjectId("58e6684f35dc110d1c52585b"),
          "boolean" : {
              "default" : true,
              "exclusionText" : "Exclude",
              "inclusionText" : "Include"
  ...
  seedProvisionTemplates: function() {
    var self = this;
    var provisionTemplates = [
      {
          "_id" : self.ObjectId("57fa237cd0376b53ec44ede7"),
          ...
          "termTemplates" : [ 
              self.ObjectId("58e65eae35dc110d1c525852"), 
              self.ObjectId("58e65fc935dc110d1c525854"), 
              self.ObjectId("58e6605b35dc110d1c525855"), 
              self.ObjectId("58e6618f35dc110d1c525856"), 
              self.ObjectId("58e6674c35dc110d1c525858"), 
              self.ObjectId("58e667ab35dc110d1c525859"), 
              self.ObjectId("58e6681f35dc110d1c52585a")
          ],
      },
      {
          "_id" : self.ObjectId("57fa23fad0376b53ec44ede8"),
          ...
          "termTemplates" : [ 
              self.ObjectId("58e65eae35dc110d1c525852"), 
              self.ObjectId("58e65ed435dc110d1c525853"), 
              self.ObjectId("58e6618f35dc110d1c525856"), 
              self.ObjectId("58e6663f35dc110d1c525857")
          ]
      },
      {
          "_id" : self.ObjectId("57fa2473d0376b53ec44ede9"),
      ...
      {
          "_id" : self.ObjectId("57fa28088eb789a5ec49d3d5"),
          ...
          "status" : "active",
          "style" : "normal",
          "template" : "<p>The expressions with variant type are logical expressions. The nested content is displayed when the variable value equals selected option.  </p><ul><li>Variant expression (if variant1 === 'Option One'): {{#ifVariant test_variant1 'First_Option'}}variant1 equals option one{{else}}otherwise this is true{{/ifVariant}}</li></ul>",
      ...
      {
          "_id" : self.ObjectId("58e67b22f91f3ac0be6b6c49"),
          ...
          "termTemplates" : [ 
              ...
              self.ObjectId("58e667ab35dc110d1c525859"), 
              self.ObjectId("58e6681f35dc110d1c52585a"), 
              self.ObjectId("58e6684f35dc110d1c52585b")
          ]
      }
    ];
  ...
  seedDocumentTemplateTypes: function() {
    var self = this;
    var documentTemplateTypes = [
      {
          "_id" : self.ObjectId("57fa4b5315d084efeef2ba57"),
  ...
  seedDocumentTemplates: function() {
    var self = this;
    var documentTemplates = [
      {
          "_id" : self.ObjectId("57fa4b8215d084efeef2ba58"),
          "documentType" : self.ObjectId("57fa4b5315d084efeef2ba57"),
          "name" : "Variables",
          "provisionTemplates" : [ 
              self.ObjectId("57fa237cd0376b53ec44ede7")
          ],
          "status" : "active"
      },
      {
          "_id" : self.ObjectId("57faa04c8b473d77f4d4be1a"),
          "documentType" : self.ObjectId("57fa4b5315d084efeef2ba57"),
          "name" : "Simple logical expressions",
          "provisionTemplates" : [ 
              self.ObjectId("57fa23fad0376b53ec44ede8")
          ],
          "status" : "active",
      },
      {
          "_id" : self.ObjectId("57faa17b11a377a8f437cd74"),
          "documentType" : self.ObjectId("57fa4b5315d084efeef2ba57"),
          "name" : "Complex logical expressions",
          "provisionTemplates" : [ 
              self.ObjectId("57fa2473d0376b53ec44ede9")
          ],
          "status" : "active",
      },
      {
          "_id" : self.ObjectId("57faa1b011a377a8f437cd75"),
          "documentType" : self.ObjectId("57fa4b5315d084efeef2ba57"),
          "name" : "Logical expressions with variant type",
          "provisionTemplates" : [ 
              self.ObjectId("57fa28088eb789a5ec49d3d5")
          ],
          "status" : "active",
      },
      {
          "_id" : self.ObjectId("58e67b31f91f3ac0be6b6c4a"),
          "documentType" : self.ObjectId("57fa4b5315d084efeef2ba57"),
          "name" : "Functions",
          "provisionTemplates" : [ 
              self.ObjectId("58e67b22f91f3ac0be6b6c49")
          ],
          "status" : "active",
      }
    ];
  ...
  seedProjectTemplates: function() {
    var self = this;
    var projectTemplates = [
      {
          "_id" : self.ObjectId("58e66c5a35dc110d1c52585c"),
          "documentTemplates" : [ 
              self.ObjectId("57fa4b8215d084efeef2ba58"), 
              self.ObjectId("57faa04c8b473d77f4d4be1a"), 
              self.ObjectId("57faa17b11a377a8f437cd74"), 
              self.ObjectId("57faa1b011a377a8f437cd75"), 
              self.ObjectId("58e67b31f91f3ac0be6b6c4a")
          ],
          "name" : "Examples",
          "status" : "active",
          "userGroups" : [ 
              self.ObjectId("58dfa5a4317b43114750c8ca")
          ],
          "users" : []
      }
    ];
  ...
  seedProjects: function() {
    var self = this;
    var projects = [
      {
          "_id" : self.ObjectId("58e66c9235dc110d1c52585d"),
          "name" : "User1 Test Project",
          "owner" : self.ObjectId("57fa20920cb5ff30ec857430"),
          "projectTemplate" : self.ObjectId("58e66c5a35dc110d1c52585c"),
          "sharedUserGroups" : [],
          "sharedUsers" : [ 
              self.ObjectId("57fa20920cb5ff30ec857431")
          ],
          "values" : [ 
              {
                  "placeholder" : "[Text Variable 1]",
