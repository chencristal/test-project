...
module.exports = {
  ...
  HANDLEBAR: {
    STATEMENTS: ['if', 'unless', 'ifCond', 'ifVariant', 'unlessVariant', 
              'math', 'case', 'article', 'pagebreak', 'expand'],
    ...
    IFCOND_OPERATORS: ['and', 'not-and', 'and-not', 'not-and-not', 
              'or', 'not-or', 'or-not', 'not-or-not']
  },
